...
**vrcft_tray_guard** 是一个专为解决 [VRCFaceTracking](https://github.com/benaclejames/VRCFaceTracking/issues/345) 进程残留 bug 而设计的轻量级工具。它能自动监控主程序的生命周期，并在其关闭后强制清理“赖着不走”的模块进程，还你一个干净的 Steam/VRChat 运行状态。
